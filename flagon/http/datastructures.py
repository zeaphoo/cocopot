...
from flagon._internal import _missing, _empty_stream
from flagon._compat import iterkeys, itervalues, iteritems, iterlists, \
...
class CombinedMultiDict(ImmutableMultiDictMixin, MultiDict):
    ...
    >>> from flagon.datastructures import CombinedMultiDict, MultiDict
...
class Range(object):
    ...
    def make_content_range(self, length):
        """Creates a :class:`~flagon.datastructures.ContentRange` object
