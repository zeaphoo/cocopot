...
"""
    ...
    ``flagon.urls`` used to provide several wrapper functions for Python 2
...
def url_decode_stream(stream, charset='utf-8', decode_keys=False,
    ...
    :func:`~flagon.wsgi.make_line_iter`.  The generator of pairs is
    ...
    :param return_iterator: if set to `True` the `cls` argument is ignored
                            ...
                            returned
    """
    from flagon.wsgi import make_chunk_iter
    if return_iterator:
        cls = lambda x: x
    elif cls is None:
        cls = MultiDict
