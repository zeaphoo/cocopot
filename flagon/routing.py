...
from flagon.urls import url_encode, url_quote, url_join
from flagon.utils import redirect, format_string
from flagon.exceptions import HTTPException, NotFound, MethodNotAllowed
from flagon._internal import _get_environ, _encode_idna
from flagon._compat import itervalues, iteritems, to_unicode, to_bytes, \
     text_type, string_types, native_string_result, \
     implements_to_string, wsgi_decoding_dance
from flagon.datastructures import ImmutableDict, MultiDict
    ...
    `redirect_to`
        ...
        rule syntax::
            ...
            def foo_with_slug(adapter, id):
                ...
                # course has nothing to do with flagon..
...
class MapAdapter(object):
    ...
    def dispatch(self, view_func, path_info=None, method=None,
        ...
        Here a small example for the dispatch usage::
            ...
            from flagon.wrappers import Request, Response
            from flagon.wsgi import responder
            from flagon.routing import Map, Rule
    ...
    def match(self, path_info=None, method=None, return_rule=False,
        ...
        - you receive a `NotFound` exception that indicates that no URL is
          ...
          same object as `flagon.exceptions.NotFound`)
    ...
    def build(self, endpoint, values=None, method=None, force_external=False,
        ...
        :py:class:`flagon.datastructures.MultiDict`):
