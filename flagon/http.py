...
"""
    ...
    utilities such as cookie handling are documented in the `flagon.utils`
    module.
...
from flagon._internal import _cookie_quote, _make_cookie_domain, \
     _cookie_parse_impl
from flagon._compat import to_unicode, iteritems, text_type, \
...
def parse_cache_control_header(value, on_update=None, cls=None):
    ...
    .. versionadded:: 0.5
       ...
       :class:`~flagon.datastructures.RequestCacheControl` is returned.

    :param value: a cache control header to be parsed.
    :param on_update: an optional callable that is called every time a value
                      on the :class:`~flagon.datastructures.CacheControl`
                      object is changed.
    :param cls: the class for the returned object.  By default
                :class:`~flagon.datastructures.RequestCacheControl` is used.
    :return: a `cls` object.
    """
    if cls is None:
...
def parse_set_header(value, on_update=None):
    ...
    :class:`~flagon.datastructures.HeaderSet` object:
    ...
    :param on_update: an optional callable that is called every time a
                      value on the :class:`~flagon.datastructures.HeaderSet`
                      object is changed.
    :return: a :class:`~flagon.datastructures.HeaderSet`
    """
    if not value:
...
def parse_authorization_header(value):
    ...
    not given, otherwise an :class:`~flagon.datastructures.Authorization`
    object.

    :param value: the authorization header to parse.
    :return: a :class:`~flagon.datastructures.Authorization` object or `None`.
    """
    if not value:
        return
...
def parse_www_authenticate_header(value, on_update=None):
    ...
    :class:`~flagon.datastructures.WWWAuthenticate` object.

    :param value: a WWW-Authenticate header to parse.
    :param on_update: an optional callable that is called every time a value
                      on the :class:`~flagon.datastructures.WWWAuthenticate`
                      object is changed.
    :return: a :class:`~flagon.datastructures.WWWAuthenticate` object.
    """
    if not value:
...
def parse_if_range_header(value):
    ...
    a :class:`~flagon.datastructures.IfRange` object.
...
def parse_range_header(value, make_inclusive=True):
    """Parses a range header into a :class:`~flagon.datastructures.Range`
...
def parse_content_range_header(value, on_update=None):
    ...
    :class:`~flagon.datastructures.ContentRange` object or `None` if
    ...
    :param on_update: an optional callable that is called every time a value
                      on the :class:`~flagon.datastructures.ContentRange`
                      object is changed.
    """
    if value is None:
        return None
...
def parse_etags(value):
    ...
    :return: an :class:`~flagon.datastructures.ETags` object.
    """
    if not value:
        return ETags()
    strong = []
