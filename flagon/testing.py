...
from flagon._compat import iterlists, iteritems, itervalues, to_bytes, \
     string_types, text_type, reraise, wsgi_encoding_dance, \
     make_literal_wrapper
from flagon._internal import _empty_stream, _get_environ
from flagon.wrappers import BaseRequest
from flagon.urls import url_encode, url_fix, iri_to_uri, url_unquote, \
     url_unparse, url_parse
from flagon.wsgi import get_host, get_current_url, ClosingIterator
from flagon.utils import dump_cookie
from flagon.datastructures import FileMultiDict, MultiDict, \
     CombinedMultiDict, Headers, FileStorage

from contextlib import contextmanager
from flagon import _request_ctx_stack
...
def File(fd, filename=None, mimetype=None):
    ...
    warn(DeprecationWarning('flagon.test.File is deprecated, use the '
...
class FlagonClient(Client):
    """Works like a regular Werkzeug test client but has some knowledge about
    how Flagon works to defer the cleanup of the request context stack to the
    end of a with body when used in a with statement.  For general information
    about how to use this class refer to :class:`flagon.test.Client`.
    ...
    def session_transaction(self, *args, **kwargs):
        ...
        :meth:`~flagon.Flagon.test_request_context` which are directly
        passed through.
        """
    ...
    def open(self, *args, **kwargs):
        kwargs.setdefault('environ_overrides', {}) \
            ['flagon._preserve_context'] = self.preserve_context
