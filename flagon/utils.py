...
from flagon.http import quote_header_value, unquote_header_value, \
     cookie_date

# DEPRECATED
# these objects were previously in this module as well.  we import
# them here for backwards compatibility with old pickles.
from flagon.datastructures import MultiDict, CombinedMultiDict, \
     Headers, EnvironHeaders
from flagon.http import parse_cookie, dump_cookie
