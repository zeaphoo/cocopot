...
"""
    ...
    For bigger applications you should consider using `flagon.script`
...
import flagon
from flagon._internal import _log
from flagon._compat import reraise, wsgi_encoding_dance
from flagon.urls import url_parse, url_unquote
from flagon.exceptions import InternalServerError
...
class WSGIRequestHandler(BaseHTTPRequestHandler, object):
    ...
    def server_version(self):
        return 'Werkzeug/' + flagon.__version__
    ...
    def make_environ(self):
        ...
        environ = {
            ...
            'wsgi.run_once':        False,
            'flagon.server.shutdown': shutdown_server,
...
def run_simple(hostname, port, application, use_reloader=False,
    ...
    :param use_debugger: should the flagon. debugging system be used?
...
def main():
    ...
    import optparse
    from flagon.utils import import_string
